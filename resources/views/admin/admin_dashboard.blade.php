    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
        <div>
            ...
            <p class="text-muted small mb-0">
                Manage your platform users and their subscription statuses.
            </p>
        </div>

        <button type="button"
                class="btn btn-primary rounded-3 px-3 py-2 fw-bold text-white shadow-sm d-flex align-items-center gap-2 pb-ts-btn-main">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            <div class="pb-ts-card bg-white p-4 rounded-4 border shadow-sm h-100 d-flex align-items-center justify-content-between">
                ...
                <div>
                    ...
                    <h3 class="fw-bold text-dark mb-1 fs-2 pb-ts-heading">
                        {{ $users->count() }}
                    </h3>
                ...
                <div class="pb-admin-stat-icon bg-primary text-white rounded-3 d-flex align-items-center justify-content-center"
        ...
        <div class="col-md-4">
            <div class="pb-ts-card bg-white p-4 rounded-4 border shadow-sm h-100 d-flex align-items-center justify-content-between">
                ...
                <div class="pb-admin-stat-icon bg-primary-subtle text-primary rounded-3 d-flex align-items-center justify-content-center"
                     style="width: 48px; height: 48px;">
        ...
        <div class="col-md-4">
            <div class="pb-ts-card bg-white p-4 rounded-4 border shadow-sm h-100 d-flex align-items-center justify-content-between">
                ...
                <div class="pb-admin-stat-icon pb-ts-subcard text-muted rounded-3 d-flex align-items-center justify-content-center border"
                     style="width: 48px; height: 48px;">
            ...
            <form action="{{ url('/admin_dashboard') }}" method="GET">
                ...
                <div class="input-group pb-ts-input-group"
                    ...
                    <input
                        ...
                        name="search"
                        value="{{ $search ?? '' }}"
                        class="form-control border-start-0 ps-2 pb-ts-input extra-small"
            ...
            <table class="table table-hover align-middle mb-0 pb-admin-table">
                ...
                <thead>
                    ...
                    <tr class="text-muted extra-small text-uppercase pb-admin-table-header">
                        ...
                        <th class="fw-bold text-end pe-3">
                            Actions
                        </th>
                        ...
                        @foreach($users as $user)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <h6 class="fw-bold text-dark mb-0 small pb-ts-label">
                                ...
                                <td>
                                    ...
                                    <span class="badge bg-success-subtle text-success border border-success-subtle rounded-pill px-3 py-1 fw-semibold extra-small">
        ...
        <div class="p-3 border-top pb-ts-border-subtle pb-ts-subcard d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <span class="small text-muted">
                ...
                @else
                    ...
                    Showing {{ $users->count() }} result{{ $users->count() != 1 ? 's' : '' }}
