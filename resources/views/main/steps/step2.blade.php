    ...
    <div class="pb-ts-card bg-white rounded-4 border shadow-sm p-4 p-sm-5 mb-4">
        ...
        <div class="d-flex align-items-center gap-4 mb-4 pb-4 border-bottom pb-ts-border-subtle flex-wrap">
            <div class="position-relative">
                <img id="avatarPreviewImg" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=200&auto=format&fit=crop" class="rounded-circle object-fit-cover border" width="80" height="80" alt="Profile Photo">
                ...
                <input type="file" id="avatarFileInput" name="avatar" class="d-none" accept="image/*" onchange="previewUserAvatar(this)">
            </div>
            <div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group pb-ts-input-group">
                    ...
                    <input type="text" class="form-control border-start-0 ps-2 pb-ts-input" id="s2TitleRole" name="role" placeholder="Senior Product Designer" required>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group pb-ts-input-group">
                    ...
                    <input type="tel" class="form-control border-start-0 ps-2 pb-ts-input" id="s2Phone" name="phone" placeholder="+1 (555) 000-0000">
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <textarea class="form-control pb-ts-textarea" id="s2Bio" name="bio" rows="4" maxlength="300" placeholder="Briefly describe your professional background and what drives your creativity..." oninput="document.getElementById('bioCharCount').innerText = this.value.length"></textarea>
            </div>
