<div class="pb-ts-slide" data-slide="5">
    ...
    <div id="featuredProjectsContainer" class="d-flex flex-column gap-3 mb-4">
        ...
        <!-- Project Item 2 -->
        <div class="pb-ts-card bg-white p-4 rounded-4 border shadow-sm pb-ts-project-card" data-project-id="2">
            <div class="row align-items-center g-4">
                <!-- Thumbnail -->
                <div class="col-md-4 col-lg-4">
                    <img src="https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=80&w=600&auto=format&fit=crop" class="img-fluid rounded-3 border object-fit-cover w-100" style="max-height: 160px;" alt="FinFlow Mobile">
                </div>
                <!-- Details -->
                <div class="col-md-8 col-lg-8">
                    <div class="d-flex align-items-start justify-content-between mb-2">
                        <h5 class="fw-bold text-dark mb-0 pb-ts-heading">FinFlow Mobile</h5>
                        <div class="d-flex align-items-center gap-2">
                            <button type="button" class="btn btn-link text-muted p-0 border-0" title="Edit Project">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                            </button>
                    ...
                    <p class="text-secondary small mb-3">
                        Cross-platform mobile wallet with biometric security and real-time transaction tracking for international enterprise clients.
                    </p>
                    <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                        <span class="badge bg-primary-subtle text-primary fw-bold px-2 py-1 extra-small rounded-2">REACT NATIVE</span>
                        <span class="badge bg-primary-subtle text-primary fw-bold px-2 py-1 extra-small rounded-2">NODE.JS</span>
                        <span class="badge bg-primary-subtle text-primary fw-bold px-2 py-1 extra-small rounded-2">GRAPHQL</span>
                    </div>
                    <a href="https://project-finflow.io" target="_blank" class="extra-small text-primary fw-semibold text-decoration-none d-inline-flex align-items-center gap-1">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>
                        <span>project-finflow.io</span>
                    </a>
                </div>
            </div>
        </div>
